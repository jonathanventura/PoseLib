...
int relpose_2aff_shared_focal(const std::vector<Eigen::Vector3d> &u, const std::vector<Eigen::Vector3d> &v, const std::vector<Eigen::Matrix2d> &A,
    ...
    return relpose_shared_focal(epipolar_constraints, u, v, out_image_pairs);
}
